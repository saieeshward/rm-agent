  1. Scrape the live data site (Playwright, 100/page, list → detail) and load it into Postgres via an idempotent ETL. Match your load to /verify on scrape day.
  ...
  5. Write tests: ETL ≥3, tools ≥10, skills ≥5, agent ≥4.
